return {
  ...
  config = function()
    ...
    local function set_rel_number_colors()
      ...
      vim.cmd(string.format("highlight HL_RltvNmbr_Minus gui=none,italic guifg=%s guibg=%s", primary_fg, normal_bg))
      vim.cmd(
        string.format("highlight HL_RltvNmbr_Positive gui=none,italic guifg=%s guibg=%s", secondary_fg, normal_bg)
      )
    end
